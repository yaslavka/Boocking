...
export const numberManagerUploadImage = (data) => baseInstance.post(`/number_manager_image`, data, {headers: {
  'Content-Type': 'multipart/form-data',
}});

export const numberManagerUploadAlbum = (data) => baseInstance.post(`/number_manager_album`, data, {headers: {
  'Content-Type': 'multipart/form-data',
}});
