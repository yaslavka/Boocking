...
function SelectObject({ object, index, reservationManager, userInfo, user }) {
  ...
  const liftingServiceRed =
    (object?.promotionHotel?.length > 0 &&
      object?.promotionHotel.filter(
        (i) => i.promotionHotel === 'Поднятие' && i?.status === true,
      )[0]?.daysLeft) ||
    100
  const liftingServiceGrey =
    (object?.promotionHotel?.length > 0 &&
      object?.promotionHotel.filter(
        (i) => i.promotionHotel === 'Поднятие' && i?.status === true,
      )[0]?.daysHavePassed) ||
  ...
  const highlightGrin =
    object?.promotionHotel?.length > 0 &&
    object?.promotionHotel.filter(
      (i) => i?.promotionHotel === 'Выделение' && i?.status === true,
    )[0]?.daysLeft
      ? object?.promotionHotel.filter(
          (i) => i?.promotionHotel === 'Выделение' && i?.status === true,
        )[0]?.daysLeft
  ...
  const premiumBlue =
    object?.promotionHotel?.length > 0 &&
    object?.promotionHotel.filter(
      (i) => i?.promotionHotel === 'Премиум' && i?.status === true,
    )[0]?.daysLeft
      ? object?.promotionHotel.filter(
          (i) => i?.promotionHotel === 'Премиум' && i?.status === true,
        )[0]?.daysLeft
  ...
  const vipBlockGrey =
    object?.promotionHotel?.length > 0 &&
    object?.promotionHotel.filter(
      (i) => i?.promotionHotel === 'VIP БЛОК' && i?.status === true,
    )[0]?.daysLeft
      ? object?.promotionHotel.filter(
          (i) => i?.promotionHotel === 'VIP БЛОК' && i?.status === true,
        )[0]?.daysLeft
          ...
          <>
            <Col xl={3}>
              <div className={styles.colInfoUserHotel}>
                <h1 className={styles.colInfoUserHotelTitle}>Информация</h1>
                ...
                <Link
                  ...
                  to={`/hotel_edit/${object.id}`}
                >
                  <svg fill="#B19AF2" width={30} viewBox="0 0 24 24">
            ...
            <div className={styles.chartContainer}>
              ...
              <div className={styles.absolute}>
                ...
                <div className={styles.subTextService}>
                  ...
                  object?.promotionHotel.filter(
                    (i) =>
                      i?.promotionHotel === 'Поднятие' && i?.status === true,
                  )[0]?.daysHavePassed
                    ? object?.promotionHotel.length > 0 &&
                      object?.promotionHotel.filter(
                        (i) =>
                          i?.promotionHotel === 'Поднятие' &&
                          i?.status === true,
                      )[0]?.daysHavePassed
                    : 0}{' '}
                  ДНЕЙ
            ...
            <div className={styles.chartContainer}>
              ...
              <div className={styles.absolute}>
                ...
                <div className={styles.subTextService}>
                  ...
                  object?.promotionHotel.filter(
                    (i) =>
                      i?.promotionHotel === 'Выделение' && i?.status === true,
                  )[0]?.daysHavePassed
                    ? object?.promotionHotel.length > 0 &&
                      object?.promotionHotel.filter(
                        (i) =>
                          i?.promotionHotel === 'Выделение' &&
                          i?.status === true,
                      )[0]?.daysHavePassed
                    : 0}{' '}
                  ДНЕЙ
            ...
            <div className={styles.chartContainer}>
              ...
              <div className={styles.absolute}>
                ...
                <div className={styles.subTextService}>
                  ...
                  object?.promotionHotel.filter(
                    (i) =>
                      i?.promotionHotel === 'Премиум' && i?.status === true,
                  )[0]?.daysHavePassed
                    ? object?.promotionHotel.length > 0 &&
                      object?.promotionHotel.filter(
                        (i) =>
            ...
            <div className={styles.chartContainer}>
              ...
              <div className={styles.absolute}>
                ...
                <div className={styles.subTextService}>
                  ...
                  object?.promotionHotel.filter(
                    (i) =>
                      i?.promotionHotel === 'VIP БЛОК' && i?.status === true,
                  )[0]?.daysHavePassed
                    ? object?.promotionHotel.length > 0 &&
                      object?.promotionHotel.filter(
                        (i) =>
                          i?.promotionHotel === 'VIP БЛОК' &&
                          i?.status === true,
                      )[0]?.daysHavePassed
                    : 0}{' '}
                  ДНЕЙ
