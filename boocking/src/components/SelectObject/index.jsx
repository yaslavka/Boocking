...
function SelectObject({object, index, reservationManager, userInfo, user}) {
  ...
  const liftingServiceRed = object?.promotionHotel?.length > 0 && object?.promotionHotel.filter((i)=>i.promotionHotel === 'Поднятие' && i?.status === true)[0]?.daysLeft || 100;
  const liftingServiceGrey = object?.promotionHotel?.length > 0 && object?.promotionHotel.filter((i)=>i.promotionHotel === 'Поднятие' && i?.status === true)[0]?.daysHavePassed || 0;
  ...
  const highlightGrin = object?.promotionHotel?.length > 0 && object?.promotionHotel.filter((i)=>i?.promotionHotel === 'Выделение' && i?.status === true)[0]?.daysLeft ? object?.promotionHotel.filter((i)=>i?.promotionHotel === 'Выделение' && i?.status === true)[0]?.daysLeft : 100;
  const highlightGrey = object?.promotionHotel?.length > 0 && object?.promotionHotel.filter((i)=>i?.promotionHotel === 'Выделение' && i?.status === true)[0]?.daysHavePassed ? object?.promotionHotel.filter((i)=>i?.promotionHotel === 'Выделение' && i?.status === true)[0]?.daysHavePassed : 0;
  const highlights = {
    datasets: [
      {
  ...
  const premiumBlue = object?.promotionHotel?.length > 0 && object?.promotionHotel.filter((i)=>i?.promotionHotel === 'Премиум' && i?.status === true)[0]?.daysLeft ? object?.promotionHotel.filter((i)=>i?.promotionHotel === 'Премиум' && i?.status === true)[0]?.daysLeft : 100;
  const premiumGrey = object?.promotionHotel?.length > 0 && object?.promotionHotel.filter((i)=>i?.promotionHotel === 'Премиум' && i?.status === true)[0]?.daysHavePassed ? object?.promotionHotel.filter((i)=>i?.promotionHotel === 'Премиум' && i?.status === true)[0]?.daysHavePassed : 0;
  const premiums = {
    datasets: [
      {
  ...
  const vipBlockGrey = object?.promotionHotel?.length > 0 && object?.promotionHotel.filter((i)=>i?.promotionHotel === 'VIP БЛОК' && i?.status === true)[0]?.daysLeft ? object?.promotionHotel.filter((i)=>i?.promotionHotel === 'VIP БЛОК' && i?.status === true)[0]?.daysLeft : 100;
  const vipBlockV = object?.promotionHotel?.length > 0 && object?.promotionHotel.filter((i)=>i?.promotionHotel === 'VIP БЛОК' && i?.status === true)[0]?.daysHavePassed ? object?.promotionHotel.filter((i)=>i?.promotionHotel === 'VIP БЛОК' && i?.status === true)[0]?.daysHavePassed : 0;
  const vipBlock = {
    datasets: [
      {
