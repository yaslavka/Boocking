  ...
  const packagesConfirmValue = async () => {
    ...
    const result = await confirm({
      ...
      message: `${t('Поднятие в списке на')} ${days} ${declOfNum(days, [
        ...
        days * Number(vipPackage.price) +
        days * Number(liftingPackage.price) +
        days * Number(highlightPackage.price) +
        days * Number(premiumPackage.price)
      }  RUB?`,
