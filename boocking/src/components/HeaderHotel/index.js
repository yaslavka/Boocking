...
function HeaderHotel({ hotelId, number, numberId }) {
  return (
    <>
      {number ? (
        <>
          <div className={styles.header}>
            <div className={styles.headerTitle}>{numberId.nameNumber}</div>
            <Rating initialValue={2.5} SVGstorkeWidth={0} />
          </div>
          <div className={`${styles.flex} ${styles.marginBottom}`}>
            <section>
              <div className={styles.flex}>
                <span className={styles.nameHotel}>{numberId.typeNumber}</span>
                <img src={key} alt={key} />
              </div>
              <div className={styles.flex}>
                <div className={`${styles.itemAddress}`}>
                  ...
                  <div className={styles.omMap}>{hotelId.address}</div>
                </div>
                <div className={`${styles.itemAddress}`}>
                  <Link to={'#'} className={`${styles.link} `}>
                    <svg
                  ...
                  <div className={styles.omMap}>{hotelId.phone}</div>
                </div>
              </div>
              <div className={styles.flex}>
        ...
        <>
          <div className={styles.header}>
            <div className={styles.headerTitle}>{hotelId.typeHotel}</div>
            <Rating initialValue={2.5} SVGstorkeWidth={0} />
          </div>
          <div className={`${styles.flex} ${styles.marginBottom}`}>
            <section>
              <div className={styles.flex}>
                <span className={styles.nameHotel}>{hotelId.nameHotel}</span>
                <img src={key} alt={key} />
              </div>
              <div className={styles.flex}>
                <div className={`${styles.itemAddress}`}>
