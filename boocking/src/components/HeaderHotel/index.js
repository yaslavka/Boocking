            ...
            <div className={`${styles.flex} ${styles.marginBottom}`}>
              <section>
                ...
                <div className={styles.flex}>
                  <div className={`${styles.itemAddress}`}>
                    <Link to={'#'} className={`${styles.link} `}>
                      <svg height={28} width={45} className={styles.omMap} focusable='false' aria-hidden='true'
                        fill={'#d9ccf8'}>
                        <path
                ...
                <div className={styles.flex}>
                  ...
                  <section className={styles.flex}>
                    <svg fill='#D9CCF8' width='25' focusable='false' aria-hidden='true' viewBox='0 0 24 24'
