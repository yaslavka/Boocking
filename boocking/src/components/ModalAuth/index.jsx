        ...
        () =>
            yup.object().shape({
                ...
                phone: yup
                    .string()
                    .required('signInPage.inputs.password.error')
                    .test('phone', t('signInPage.inputs.password.error'), (value) => isValidPhone(value)),
                username: yup
                    .string()
                    .required('signInPage.inputs.password.error')
                    .test('username', t('signInPage.inputs.username.error'), (value) => isValidUsername(value)),
                email: yup
                    .string()
                    .required('signInPage.inputs.password.error')
                    .test('email', t('signInPage.inputs.username.error'), (value) => isValidEmail(value)),
                password: yup
                    .string()
                    .required('signInPage.inputs.password.error')
                    .test('password', t('signInPage.inputs.password.error'), (value) => isValidPassword(value)),
    ...
    return (
        <>
            <Modal show={authVisible} onHide={modalAuthVisible}>
                ...
                <Formik initialValues={tabActive ? initialValues : initialValuesSignUp} onSubmit={onSubmit} validationSchema={tabActive ? validationSchema : validationSchemaSignUp}>
                    {()=>(
                        <Form>
                            <div className={styles.authFormTabs}>
                                <div className={tabActive? styles.authFormTabActive: styles.authFormTab} onClick={()=>setTabsActive(true)}
                                     data-auth-tab-id="login-d">
                                    <span> Войти </span>
                                </div>
                                <div className={tabActive? styles.authFormTab: styles.authFormTabActive} onClick={()=>setTabsActive(false)}
                                     data-auth-tab-id="login-d">
