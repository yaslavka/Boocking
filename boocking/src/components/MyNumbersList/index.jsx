...
function MyNumbersList({number}) {
  return (
    <>
      <Col lg={4} className={styles.list}>
        <Link to={`/my_hotel/number-edit/${number?.id}`} className={styles.images_link}>
          <div className={styles.absolute}>
            ...
            <img
              ...
              alt={number?.nameNumber} className={styles.images}/>
