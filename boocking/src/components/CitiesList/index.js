...
function CitiesList({citi}) {
    return (
        <>
            <Col lg={4} className={`${styles.list}`}>
                <Link to={`/search_hotel_home/${citi.id}`} className={styles.images_link}>
                    <div className={styles.absolute}>
                        ...
                        <img src={`${process.env.REACT_APP_BASE_AVATAR_URL}/${citi.geo_city_images}`} alt={citi.geo_city} className={styles.images}/>
                        <div className={`${styles.button_pr}`}>
                            ...
                            <div className={`${styles.primary_btn_absolute} ${styles.primary_btn}`} style={{zIndex: 1, color: "#fff"}}>{citi.geo_city}</div>
                        </div>
                    </div>
                </Link>
            </Col>
