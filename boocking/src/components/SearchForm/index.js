      ...
      <div className={path !== `/search_hotel_home/${pathId}`? styles.search : styles.search2}>
                  ...
                  <div className="guests-popup__adults">
                    ...
                    <div className="toggle-buttons">
                      ...
                      <label htmlFor="guests-popup__adult-4"
                        className="toggle-buttons__label" onClick={()=>{
                  ...
                  <div className="guests-popup__footer">
                    <div className=" button-ss">
                      <div className=" text-left">
                        <Button type="button"
                          className="guests-popup__close guests-popup__button button" onClick={()=>{
                            setPeople({value: 0, label: ''}); setChild({value: 0, label: ''}); setStartDateVisible(false);
                          }}>Отмена
                        </Button>
                      </div>
        ...
        <section className={`${styles.section}`} style={ {display: inputAction ? 'flex': 'none'}}>
          {filterCiti && filterCiti.map((citi, index)=>(
            <div className={styles.search_link} key={index} role={'button'} onClick={()=>{
              setId(citi.id); setSearch({search: citi.geo_city}); setInputAction(false);
            }}>
