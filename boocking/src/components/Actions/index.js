                        ...
                        {actions.map((item, index)=>(
                            <div key={index} className={styles.actionsWrapperContainer}>
                                <div className={styles.actionsContent}>
                                    ...
                                    <svg width="300" height="2" fill="none" xmlns="http://www.w3.org/2000/svg"><line x1="-0.00109863" y1="0.75" x2="325" y2="0.75" stroke="#D9CCF8" strokeOpacity="0.6"/></svg>
                                    <div style={{paddingLeft: 15, fontWeight: 500, marginBottom: 10, alignItems: "flex-start", textAlign: "left"}}>
                                        {item.nameHotel}
                                    </div>
                                    ...
                                    <div style={{padding: 10, marginBottom: 10}}>
                                        <h1 style={{fontSize: 15, fontWeight: 200, color: "#8c8c8c"}}>оценка: <i style={{fontWeight: 500}}>9,3/10</i> | <i className="fa fa-comment"> </i> Отзывов: 53</h1>
                                    </div>
