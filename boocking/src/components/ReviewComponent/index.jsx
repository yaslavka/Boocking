        ...
        <>
            <Row className={styles.reviewContainer}>
                <Col xl={3} className={styles.reviewCol}>
                    ...
                    {hotelId.bal > 6 ? (
                        <div className={styles.reviewBalText}>
                            очень хорошо
                        </div>
                    ):(
                        <div className={styles.reviewBalText}>
            ...
            <Button className={styles.reviewButtonMor} onClick={()=>loadMorReview()}>
                <span>
                    Показать все Отзывы ({hotelId.review.length} шт.) <span className="fa fa-arrow-down"></span>
                </span>
            </Button>
        </>
    )
