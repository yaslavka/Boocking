...
function Header() {
  ...
  return (
    <>
      <div className={styles.header}>
        <div className={styles.inner}>
          <div
            ...
            className={
              navbarVisible
                ? `${styles.button} ${styles.menu} ${styles.pull_left} ${styles.active}`
                : `${styles.button} ${styles.menu} ${styles.pull_left}`
            }
          ...
          >
            <div className={`${styles.button}`}>
              <div className={styles.text}>
                ...
                <span className={'px-2'}>{t('header.bronSearch')}</span>
              </div>
            </div>
          </div>
          {userInfo ? (
            <>
              <Link
                className={`${styles.account} dropdown pull-right`}
                to={routesLik.dashboard}
              >
                <div className={styles.button}>
                  <span className={styles.text}>
                    ...
                    />
                    <div className="px-2">{t('header.auth')}</div>
                  </span>
                </div>
              </Link>
            </>
      ...
      {bronVisible && (
        <ModalBrone
          searchBronVisible={searchBronVisible}
          bronVisible={bronVisible}
          t={t}
        />
      )}
      {authVisible && (
        <ModalAuth
          ...
          modalAuthVisible={modalAuthVisible}
        />
      )}
    </>
  )
