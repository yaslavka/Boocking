      ...
      <div className={styles.advansagesPages}>
        ...
        <div className={styles.advansagesPagesImag}>
          <div className={styles.advansagesPagesImagesText}>
            ...
            <div>
              <div style={{ width: 400, marginBottom: 10 }}>
                Оплата производится в рублях, наличными денежными средствами,
                путем безналичного перечисления по договору бронирования или с
                использованием расчетных (кредитных) карт. Поселение в отель
                производится только после внесения Гостем оплаты проживания.
                Фискальный чек и окончательный счет за оказанные услуги выдается
                при выезде Гостя.
              </div>
              <div style={{ width: 400 }}>
                Вне зависимости от вида поселения, в случае задержки выезда
                Гостя после расчетного часа на срок не более 6 часов
                производится почасовая оплата. При задержке выезда на срок от 6
                до 12 часов после расчетного часа плата взимается за половину
                суток. При выезде по истечении более 12 часов после расчетного
                часа оплата производится как за полные сутки.
              </div>
            </div>
            <div>
              <div style={{ width: 400, marginBottom: 10 }}>
                К гостям отеля могут приходить посетители с 8.00 до 23.00 часов.
                Администратор должен вести запись всех визитеров. Посетители
                обязаны представить документ, подтверждающий их личность
                администратору. За них отвечает проживающий в номере.
              </div>
              <div style={{ width: 400 }}>
                Смена постельного белья осуществляется один раз в два дня,
                полотенец и туалетных принадлежностей производится один раз в
                сутки. По просьбе Гостя и за дополнительную плату может быть
        ...
        <div className={styles.advansagesPagesImag}>
          <div className={styles.advansagesPagesImagesText}>
            <div>
              <div style={{ width: 400, marginBottom: 10 }}>
                Гость обязан бережно относиться к имуществу и оборудованию отеля
                «HATTI LOFT HOTEL», соблюдать установленный порядок проживания.
                В случае утраты или повреждения Гостем имущества отеля он
                возмещает стоимость нанесенного ущерба на основании действующего
                прейскуранта.
              </div>
              <div style={{ width: 400 }}>
                Оставлять в номере посторонних лиц, а также передавать им ключ
                от номера. В случае утери ключа гость оплачивает стоимость ключа
                в размере 700 руб.;
              </div>
            </div>
            <div>
