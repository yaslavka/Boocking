...
function NumberChoice({setEndDates, endDates, setStartDate, startDate, setRoom, setGo}) {
  return (
    <>
      <section className={styles.numberChoiceContainer}>
        ...
        <Form className={styles.numberChoiceForm}>
          ...
          <article className={styles.dtaPicker}>
            ...
            <select id="formatr" onChange={(e)=>setRoom(e.target.value)}>
              <option value="" disabled selected hidden>Количество комнат</option>
              <option value="1" >1</option>
              <option value="2" >2</option>
              <option value="3" >3</option>
              <option value="4">4</option>
