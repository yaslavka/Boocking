  ...
  return (
    <section className={styles.recommended}>
      <div className={styles.wrapper}>
        <h1 className={styles.title}>{t('Мы рекомендуем')}</h1>
        <h2 className={styles.title}>{t('ЛУЧШИЕ ГОСТИНИЦИ')}</h2>
            ...
            <div className={styles.container} key={index}>
              <div className={styles.content}>
                <img
                  width={290}
                  height={212}
                  src={`${process.env.REACT_APP_BASE_AVATAR_URL}/${item.imageHotel}`}
                  alt={item.nameHotel}
              ...
              <div className={styles.wraper_bottom}>
                <div className={styles.wraper}>
                  <div className={styles.wraper}>
                    <svg fill='#D9CCF8' width={15} focusable='false' viewBox='0 0 24 24'>
                  ...
                  <div className={styles.wraper}>
                    <svg fill='#D9CCF8' width={15} focusable='false' aria-hidden='true' viewBox='0 0 24 24'>
                  ...
                  <div className={styles.wraper}>
                    <svg fill='#D9CCF8' width={15} height={15} focusable='false' viewBox='0 0 24 24'>
              ...
              <div className={styles.address_container}>
                <div className={styles.address_text}>
                  <svg fill='#D9CCF8' width={20} focusable='false' aria-hidden='true' viewBox='0 0 24 24'>
              ...
              <div className={styles.price_container}>
                <div style={{ fontSize: 20, color: '#7E7E7E', fontWeight: 'bold' }}>
                  От{' '}
                  <span style={{ fontSize: 25, fontWeight: 900, color: '#050505', alignItems: 'center' }}>
                  {item.price}
                </span>{' '}
                  <span>₽</span>
              ...
              <div className={styles.button_container}>
                <div className={styles.icons_container}>
                  ...
                  <div className={styles.icons}>
                    <svg fill='#D6D6D6' width={30} height={30} aria-hidden='true' viewBox='0 0 24 24'>
