              ...
              <div className={styles.container} key={index}>
                <div className={styles.content}>
                  ...
                  <h1 className={styles.ocenka}>
                    оценка: <i className={styles.fontWeight}>{item.bal}/10</i> |{' '}
                    <i className="fa fa-comment" /> Отзывов: 53
                  </h1>
                </div>
                ...
                <div className={styles.distance_pges}>
                  <div className={styles.distance}>
                    <div className={`${styles.distance} px-1`}>До пляжа:</div>{' '}
                    {item.distanceTo} М.
                  </div>
                  <div className={styles.distance}>
                    <div className={`${styles.distance} px-1`}>До центра:</div>{' '}
                    {item.distanceCenter} М.
                  </div>
                </div>
