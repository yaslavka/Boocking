...
function HotelId() {
    ...
    const broneceng = async (count, price, index, startDate, endDates)=>{
        ...
        if (result) {
            dispatch(reservationActions.reservationBook({id:index, count:count, sum: planetLength * +price, startDate:startDate, endDates:endDates}))
        }
    }
    return (
        <>
                    ...
                    <Row>
                        ...
                        {hotelId && (
                            <Col xl={9} >
                                ...
                                <section className={styles.section}>
                                    {slice && (
                                        <Row>
                                            ...
                                            <Button color={'primary'} type={"button"} onClick={LoadMor} className={styles.loadMor}>
                                ...
                                {sliceReview && (
                                    <ReviewComponent review={sliceReview} hotelId={hotelId} loadMorReview={loadMorReview}/>
                                )}
                            </Col>
                        )}
                    </Row>
