...
function Dashboard() {
  ...
  const reservationSlice =
    reservation?.length > 0 && reservation.slice(0, valueSlice)
  return (
    <>
      {userInfo && (
        <PrivateNavbar>
          ...
          <div className={styles.selectObject}>
            <div className={styles.selectObjectText}>
              {userInfo.isManager && <>Мои Отели</>}
              {!userInfo.isManager && <>Мои брони</>}
            </div>
