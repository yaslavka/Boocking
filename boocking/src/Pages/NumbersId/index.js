...
function NumbersId() {
    ...
    const handleChangPositive = (event)=>{
        setReviewText(prevState => ({...prevState, positive: event.target.value}))
    }
    const handleChangNegative = (event)=>{
        setReviewText(prevState => ({...prevState, negative: event.target.value}))
    }
    const reviewSend = (e)=>{
        e.preventDefault();
        dispatch(numberIdActions.reviewSend({location, service, price, purity, nutrition, dream, positive, negative}))
    }
    return (
        <>
                    ...
                    {numberId && hotelId && (
                        <Col xl={9}>
                            ...
                            <section className={styles.section}>
                                <Row>
                                    <Col xl={9}>
                                        <DescriptionHotel hotelId={hotelId} numberId={numberId} number/>
                                    </Col>
                                    <Col xl={3}>
                            ...
                            <section className={styles.section}>
                                <Form onSubmit={reviewSend}>
                                    ...
                                    <section className={styles.section}>
                                        <textarea placeholder="Положительный отзыв" name="positive" value={positive} onChange={handleChangPositive}/>
                                    </section>
                                    <section className={styles.section}>
                                        <textarea placeholder="Отрецательный отзыв" name="positive" value={negative} onChange={handleChangNegative}/>
                                    </section>
                                    <section className={styles.section}>
