...
export const reservationCancel = (values) => ({
  type: ActionTypes.RESERVATION_CANCEL_REQUEST,
  payload: values,
})

export const reservationPay = (values) => ({
  type: ActionTypes.RESERVATION_PAY_REQUEST,
  payload: values,
})
